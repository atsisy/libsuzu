...
use crate::libsuzu::core::{Clock, Updatable};
...
impl<D> Drawable for DropDownArea<D>
where
    D: Drawable,
{
...
impl<D> Node2D for DropDownArea<D>
where
    D: Drawable,
{
...
impl<D> Transform for DropDownArea<D>
where
    D: Drawable,
{
...
impl Drawable for BookStatusButtonGroup {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for BookTitleMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for SimpleMessageMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for CustomerNameMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for DateCheckMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            self.date_table_frame.draw(ctx)?;
...
impl Drawable for CustomerQuestionMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for RememberCustomerNameMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for CustomerMenuGroup {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if let Some(customer_question_menu) = self.customer_question_menu.as_mut() {
...
impl Drawable for RecordBookMenuGroup {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if let Some(book_status_menu) = self.book_status_menu.as_mut() {
...
impl Drawable for BookInfoDrawer {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for DeskBookMenu {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            self.header_text.draw(ctx)?;
...
impl Drawable for OnDeskMenuGroup {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if let Some(desk_book_menu) = self.desk_book_menu.as_mut() {
