...
pub fn create_coin<'a>(
    ...
    let s_texture = Texture::new(ctx.ref_texture(texture_id), pos, scale, 0.0, 0);

    let l_texture = Texture::new(ctx.ref_texture(texture_id), pos, scale, 0.0, 0);
