...
use crate::libsuzu::graphics::object::shape;
...
impl Drawable for TaskTableStagingObject {
...
impl Drawable for TaskSilhouette {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Node2D for TaskSilhouette {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for TaskSilhouette {
...
impl Node2D for TextBalloon {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for TextBalloon {
...
impl Drawable for SuzuMiniSightSilhouette {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Node2D for SuzuMiniSightSilhouette {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for SuzuMiniSightSilhouette {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl SuzuMiniSight {
    pub fn new<'a>(ctx: &mut SuzuContext<'a>, rect: ggraphics::Rect, t: Clock) -> Self {
        ...
        let silhouette_paper_texture = Texture::new(
...
impl Drawable for SuzuMiniSight {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if self.draw_request != DrawRequest::Skip {
                self.draw_request = DrawRequest::Skip;
...
impl Drawable for ShelvingBookBox {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if self.draw_request != DrawRequest::Skip {
                self.draw_request = DrawRequest::Skip;
...
impl Drawable for KosuzuPhrase {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Drawable for FloatingMemoryObject {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Drawable for TaskInfoContents {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for TaskInfoPanel {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.draw_request != DrawRequest::Skip {
            self.draw_request = DrawRequest::Skip;
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Node2D for MoneyBox {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for MoneyBox {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl Node2D for ChatBox {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for ChatBox {
    impl_transform_object_for_wrapped! {canvas}
}
