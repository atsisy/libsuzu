...
impl Drawable for SelectBookWindowContents {
...
impl Drawable for SelectBookWindow {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Node2D for SelectBookWindow {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for SelectBookWindow {
...
impl SelectShelvingBookUI {
    pub fn new<'a>(
        ...
        let texture = Box::new(Texture::new(
...
impl Drawable for SelectShelvingBookUI {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Node2D for SelectShelvingBookUI {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for SelectShelvingBookUI {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl Drawable for SelectStoringBookWindow {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if self.redraw_request != DrawRequest::Skip {
                self.redraw_request = DrawRequest::Skip;
...
impl Node2D for SelectStoringBookWindow {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for SelectStoringBookWindow {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl Drawable for SelectStoreBookUI {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if self.redraw_request != DrawRequest::Skip {
                self.redraw_request = DrawRequest::Skip;
...
impl Node2D for SelectStoreBookUI {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for SelectStoreBookUI {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl Drawable for ShelvingDetailContents {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl ShopMenuContents {
    pub fn new<'a>(ctx: &mut SuzuContext<'a>) -> Self {
        ...
        let mut contents = ShopMenuContents {
...
impl Drawable for ShopMenuContents {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl ShopDetailMenuContents {
    pub fn new<'a>(
        ...
        ShopDetailMenuContents {
            ...
            drwob_essential: DrawableEss::new(false, 0),
...
impl Drawable for ShopDetailMenuContents {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl Drawable for SimpleBookListViewer {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            if self.redraw_request != DrawRequest::Skip {
                self.redraw_request = DrawRequest::Skip;
...
impl Node2D for SimpleBookListViewer {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for SimpleBookListViewer {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl Drawable for ShopMenuMaster {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Drawable for ShopSpecialObject {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
...
impl DrawableShopClock {
    pub fn from_toml<'a>(ctx: &mut SuzuContext<'a>, path: &str, time: ShopClock) -> Self {
        ...
        let mut long_needle_texture = Texture::new(
            ctx.ref_texture(
        ...
        let mut short_needle_texture = Texture::new(
            ctx.ref_texture(
...
impl Drawable for DrawableShopClock {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        self.background.draw(ctx)?;
...
impl Drawable for ShopMapViewer {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
        if self.is_visible() {
            sub_screen::stack_screen(ctx, &self.canvas);
...
impl Node2D for ShopMapViewer {
    impl_node2d_for_wrapped! {canvas}
}

impl Transform for ShopMapViewer {
    impl_transform_object_for_wrapped! {canvas}
}
...
impl Drawable for ShopCommandPalette {
    fn draw(&mut self, ctx: &mut ggez::Context) -> ggez::GameResult<()> {
