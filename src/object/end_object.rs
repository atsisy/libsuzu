...
use crate::libsuzu::{core::*, sound::SoundPlayFlags};
...
pub struct EndSceneFlow {
    ...
    book_collection: Vec<EffectableWrap<MovableWrap<Texture>>>,
...
デバッグをしてくれた3人";
    ...
    pub fn click_handler<'a>(
		...
		let _ = std::mem::replace(ctx.savable_data, None);
            }
        }
...
impl Drawable for EndSceneFlow {
